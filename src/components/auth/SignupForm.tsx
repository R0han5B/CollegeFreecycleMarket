  ...
  return (
    <Card className="w-full max-w-xl bg-white">
      <CardHeader className="space-y-4">
        <div className="section-badge w-fit">New Member</div>
        <div className="space-y-2">
          <CardTitle className="text-3xl font-bold text-slate-900">Create your account</CardTitle>
          <CardDescription className="text-base leading-7 text-slate-600">
            Join the RKNEC freecycling network and verify your college email before you post or connect.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {otpSent && !otpVerified && (
            <div className="space-y-2 rounded-[1.4rem] border border-slate-200 bg-orange-50 p-4">
              ...
              <p className="text-xs text-slate-500">OTP sent to your email. Valid for 5 minutes.</p>
            </div>
          )}
          ...
          <Button type="submit" className="w-full" size="lg" disabled={isLoading || !otpVerified}>
